...
CONFIG_SCHEMA_BASE = vol.Schema(
    {
        vol.Optional(Platform.ALARM_CONTROL_PANEL.value): vol.All(
            cv.ensure_list,
        ...
        vol.Optional(Platform.BUTTON.value): vol.All(
            cv.ensure_list,
            [button_platform.PLATFORM_SCHEMA_MODERN],  # type: ignore[has-type]
        ),
        vol.Optional(Platform.CAMERA.value): vol.All(
            cv.ensure_list,
        ...
        vol.Optional(Platform.SELECT.value): vol.All(
            cv.ensure_list,
        ...
        vol.Optional(Platform.SIREN.value): vol.All(
            cv.ensure_list,
